...
{{ external_markdown('Sections/Personal-data/Personal-data-adm.md', '### Подзаголовок 2') }}
...
{%
    include-markdown "Sections/Personal-data/Personal-data-adm.md"
    start="### Подзаголовок 2"
    end="### Подзаголовок 3"
%}
